            ...
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                ...
                <p class="lead mt-4 text-800 font-sans-serif fw-semi-bold w-md-75 w-xl-100 mx-auto">
                  Vous Avez pas le droit d'acceder a cette page </p>
                <hr />
                <p>Assurer vous que vous etes log in et possede les privilleges necessaire
                .</p><a class="btn btn-primary btn-sm mt-3" href="../../index.html"><span class="fas fa-home me-2">
